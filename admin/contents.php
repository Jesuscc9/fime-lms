...
if (isset($_POST['delete_video'])) {
   ...
   if ($verify_video->rowCount() > 0) {
      ...
      $message[] = 'El video ya había sido eliminado';
   }
}
...
<body>
	...
	<section class="contents">
		...
		<h1 class="heading">Tus contenidos</h1>
         ...
         ?>
			<div class="box">
				...
				<form action="" method="post" class="flex-btn">
					...
					<input type="submit" value="delete" class="delete-btn" onclick="return confirm('Borrar este video?');"
						name="delete_video">
				</form>
            ...
            echo '<p class="empty">No se han agregado contenidos aun</p>';
         }
         ?>
