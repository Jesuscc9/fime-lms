		...
		<form class="register" action="" method="post" enctype="multipart/form-data">
			...
			<div class="flex">
				<div class="col">
					...
					<p>Profesión:<span>*</span></p>
					<select name="profession" class="box" required>
						<option value="" disabled selected>-- selecciona tu profesión</option>
						<option value="developer">Desarrollador</option>
						<option value="desginer">Diseñador</option>
						<option value="musician">Maestro</option>
						<option value="biologist">Ingeniero</option>
						<option value="photographer">Otro</option>
					</select>
				...
				<div class="col">
					...
					<p>Seleccionar foto de perfil<span>*</span></p>
