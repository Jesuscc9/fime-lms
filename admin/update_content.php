	...
	<section class="video-form">
      ...
      ?>
		<form action="" method="post" enctype="multipart/form-data">
			...
			<p>Actualizar lista de reproducción</p>
		...
		<?php
         ...
         echo '<p class="empty">video not found! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Agregar videos</a></p>';
      }
      ?>
