...
<body>
	...
	<section class="quick-select d-none">
	...
	<section class="courses">
		...
		<h1 class="heading">Nuevos cursos</h1>
		...
		<div class="box-container">
			...
			<?php
				...
				echo '<p class="empty">Aun no se agregan cursos!</p>';
			}
			?>
		...
		<div class="more-btn">
			<a href="courses.php" class="inline-option-btn">Agregar más</a>
		</div>
